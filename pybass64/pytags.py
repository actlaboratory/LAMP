...
if platform.system().lower() == 'windows':
	tags_module = ctypes.WinDLL(os.path.split(__file__)[0]+'\\tags')
	func_type = ctypes.WINFUNCTYPE
else:
	tags_module = ctypes.CDLL(os.path.split(__file__)[0]+'\\tags')
...
TAGS_SetUTF8 = func_type(ctypes.c_bool, ctypes.c_bool)(("TAGS_SetUTF8", tags_module))
