...
class MainView(BaseView):
	def __init__(self):
		...
		self.previousBtn.SetLabel(_("前へ"))
		...
		self.playPauseBtn.SetBackgroundColour(self.hPanel.GetBackgroundColour())
		self.playPauseBtn.SetBitmap(wx.Bitmap("./resources/gif/play.gif", wx.BITMAP_TYPE_GIF))
		self.playPauseBtn.SetLabel(_("再生"))
		...
		self.nextBtn.SetBackgroundColour(self.hPanel.GetBackgroundColour())
		self.nextBtn.SetBitmap(wx.Bitmap("./resources/gif/next.gif", wx.BITMAP_TYPE_GIF))
		self.nextBtn.SetLabel(_("次へ"))
		...
		self.stopBtn.SetBackgroundColour(self.hPanel.GetBackgroundColour())
		self.stopBtn.SetBitmap(wx.Bitmap("./resources/gif/stop.gif", wx.BITMAP_TYPE_GIF))
		self.stopBtn.SetLabel(_("停止"))
		...
		self.repeatLoopBtn.SetBackgroundColour(self.hPanel.GetBackgroundColour())
		self.repeatLoopBtn.SetBitmap(wx.Bitmap("./resources/gif/repeatLoop.gif", wx.BITMAP_TYPE_GIF))
		self.repeatLoopBtn.SetLabel(_("リピートに切り替える"))
		...
		self.shuffleBtn.SetLabel(_("シャッフルをオンにする"))
		...
		if globalVars.app.config.getstring("view","colorMode","white",("white","dark")) == "white":
			self.muteBtn.SetBitmap(wx.Bitmap("./resources/gif/volume.gif", wx.BITMAP_TYPE_GIF))
		else: self.muteBtn.SetBitmap(wx.Bitmap("./resources/gif/volume_bk.gif", wx.BITMAP_TYPE_GIF))
		self.muteBtn.SetLabel(_("ミュートをオンにする"))
