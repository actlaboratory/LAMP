...
class MainView(BaseView):
	def __init__(self):
		...
		view_manager.setBitmapButton(self.previousBtn, self.hPanel, wx.Bitmap("./resources/gif/back.gif", wx.BITMAP_TYPE_GIF), _("前へ"))
		...
		view_manager.setBitmapButton(self.playPauseBtn, self.hPanel, wx.Bitmap("./resources/gif/play.gif", wx.BITMAP_TYPE_GIF), _("再生"))
		...
		view_manager.setBitmapButton(self.nextBtn, self.hPanel, wx.Bitmap("./resources/gif/next.gif", wx.BITMAP_TYPE_GIF), _("次へ"))
		...
		view_manager.setBitmapButton(self.stopBtn, self.hPanel, wx.Bitmap("./resources/gif/stop.gif", wx.BITMAP_TYPE_GIF), _("停止"))
		...
		view_manager.setBitmapButton(self.repeatLoopBtn, self.hPanel, wx.Bitmap("./resources/gif/repeatLoop.gif", wx.BITMAP_TYPE_GIF), _("リピートに切り替える"))
		...
		view_manager.setBitmapButton(self.shuffleBtn, self.hPanel, wx.Bitmap("./resources/gif/shuffle_off.gif", wx.BITMAP_TYPE_GIF), _("シャッフルをオンにする"))
		...
		if globalVars.app.config.getstring("view","colorMode","white",("white","dark")) == "white":
			view_manager.setBitmapButton(self.muteBtn, self.hPanel, wx.Bitmap("./resources/gif/volume.gif", wx.BITMAP_TYPE_GIF), _("ミュートをオンにする"))
		else: view_manager.setBitmapButton(self.muteBtn, self.hPanel, wx.Bitmap("./resources/gif/volume_bk.gif", wx.BITMAP_TYPE_GIF), _("ミュートをオンにする"))
